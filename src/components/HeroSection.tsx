...
const HeroSection: React.FC = () => {
  return (
    <>
      <section
        className="relative bg-cover bg-center h-[665px] flex items-center"
      ...
      >
        ...
        <div className="relative z-10 container mx-4 px-4 text-white">
          <h1 className="text-7xl font-bold font-['Playfair_Display'] mb-4 max-w-2xl">
          ...
          <div className="flex gap-4">
            <Button variant="primary" className="text-[14px] px-8" showArrow>
              Browse Properties
            </Button>
            <Button
              variant="primary"
              className="bg-white !text-[#C0581B] text-[14px] px-6"
            >
              Create Account
            </Button>
          </div>
